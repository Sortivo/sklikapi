...
public abstract class AbstractDAO<T extends SKlikObject> {
    ...
    abstract protected EntityCreationException getCreationException(String message, List<Response<T>> entityResponses, Throwable cause);
    
    abstract public List<Response<T>> create(List<T> entities) throws InvalidRequestException, EntityCreationException, SKlikException;
    abstract public List<Response<T>> update(List<T> entities) throws InvalidRequestException, EntityCreationException, SKlikException;
     ...
     * @return Response object, may contain diagnostics if it was not
     *         processed correctly but was written to SKlik. Also may contain
     ...
     */
    protected List<Response<T>> save(List<T> entities, final Set<String> ALLOWED_FIELDS, final String METHOD_NAME, final Integer REQUEST_SIZE_LIMIT)
            throws InvalidRequestException, SKlikException, EntityCreationException {
